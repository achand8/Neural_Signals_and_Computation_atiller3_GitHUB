...
print("To determine accuracy, I could watch the video and verify that the time \n"
      ...
      "correlation between the time traces and each ROI. Another important note is that\n"
      "the nucleus will not fluoresce, the ROIs drawn  may be privy to malfunctioning\n"
